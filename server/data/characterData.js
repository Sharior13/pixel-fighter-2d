const CHARACTERS = {
    luffy: {
        ...
        abilities: {
            ...
            attack2: { id: "gum_whip" },
            basic: { id: "gum_punch" },
            special: { id: "gum_gatling" },
            ultimate: { id: "king_kong_gun" }
        }
    },
    naruto: {
        id: "naruto",
...
module.exports = { CHARACTERS, getCharacterData, getAllCharacterIds, validateCharacter, getRandomCharacter, characterSpriteConfigs };